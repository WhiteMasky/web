      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center space-x-2">
              <span className="text-xl font-bold gradient-text">Active Vision</span>
            </Link>
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              AI-powered tennis analysis app that provides real-time training advice and match data.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link href="/integrations" className="text-sm text-gray-600 dark:text-gray-400 hover:text-primary">
                  Integrations
                </Link>
              </li>
              <li>
                <Link href="/changelog" className="text-sm text-gray-600 dark:text-gray-400 hover:text-primary">
                  Changelog
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link href="/cookies" className="text-sm text-gray-600 dark:text-gray-400 hover:text-primary">
                  Cookie Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-800 pt-8">
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
            &copy; {new Date().getFullYear()} Active Vision. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
